...
## Tracking Enrollee Admission
* Click on **View** to view admission
* Click on **Update** to Update  the enrollee expected discharge date
* Click on **Discharge** to discharge an enrollee from admission

<br />

  ![alt text](/images/admissiontracker.png "Title")

<br>


* Click on **track Admission** button to track Enrollee admission after selecting provider, company admisionstatus and date

<br />

  ![alt text](/images/trackAdmission.png "Title")
